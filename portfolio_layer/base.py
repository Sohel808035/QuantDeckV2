...
class PortfolioConstraints:
    ...
    max_industry_weight: float = 0.15       # Max 15% per industry
    ...
    min_cash_pct: float = 0.00              # Min cash reserve (default 0%)
    max_cash_pct: float = 0.20              # Max cash reserve (default 20%)
