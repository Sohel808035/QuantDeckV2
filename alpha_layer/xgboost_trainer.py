...
class EnsembleAlphaModel:
    ...
    def get_hyperparameters(self) -> Dict[str, Any]:
        """Retrieve the base hyperparameters used for this ensemble model."""
        return {
            "n_models": self.n_models,
            "base_params": self.base_params,
            "sub_model_params": [m.params for m in self.models]
        }

    def get_features(self) -> List[str]:
        """Retrieve the list of features the model was trained on."""
        if not self.models:
            return []
        return self.models[0].features
